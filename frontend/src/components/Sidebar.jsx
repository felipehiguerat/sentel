...
export const Sidebar = () => {
  return (
    ...
    // 1. hidden: Por defecto (móvil) NO se muestra.
    // 2. md:flex: A partir de pantallas medianas (tablets/PC) aparece y usa flexbox.
    <aside className="hidden md:flex w-20 border-r border-slate-800 flex-col items-center py-6 bg-slate-900/50 backdrop-blur-sm z-20 h-screen fixed left-0 top-0">
